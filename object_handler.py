...
class ObjectHandler:
    def __init__(self, game):
        ...
        # spawn npc
        self.enemies = self.game.levell # npc count
        self.npc_types = [SoldierNPC, soldierminigunNPC, NPC]
    ...
    def check_win(self):
      if not len(self.npc_positions):
        ...
        #video = moviepy.editor.VideoFileClip("resources/cutscene/1.mp4")
        #video.preview(height = 1020,width = 600)
        self.game.level()
        pg.display.flip()
        pg.time.delay(1500)
